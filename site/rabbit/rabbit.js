...
Elm.RabbitModel = Elm.RabbitModel || {};
Elm.RabbitModel.make = function (_elm) {
   "use strict";
   _elm.RabbitModel = _elm.RabbitModel || {};
   if (_elm.RabbitModel.values) return _elm.RabbitModel.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var initialAi = {position: {ctor: "_Tuple2",_0: 1,_1: 1},hasCargo: false};
   ...
   var winningString = "Yay, you won! These are your points: ";
   var grassColor = "chartreuse";
   var fenceColor = "brown";
   var scoreColor = "lawngreen";
   var aiColor = "red";
   var rabbitColor = "white";
   var wallColor = "black";
   var fps = 7;
   var fenceLifetime = 200;
   var bunnyBounciness = 2;
   var maxTurns = 300;
   var dimensions = 25;
   var cellSize = 25;
   var fieldSize = dimensions * cellSize;
   var Running = {ctor: "Running"};
   var End = {ctor: "End"};
   var Pause = {ctor: "Pause"};
   var BottomLeftTop = {ctor: "BottomLeftTop"};
   var RightBottomLeft = {ctor: "RightBottomLeft"};
   var TopRightBottom = {ctor: "TopRightBottom"};
   var LeftTopRight = {ctor: "LeftTopRight"};
   var Cross = {ctor: "Cross"};
   var BottomRight = {ctor: "BottomRight"};
   var TopRight = {ctor: "TopRight"};
   var LeftBottom = {ctor: "LeftBottom"};
   var LeftTop = {ctor: "LeftTop"};
   var corners = _U.list([{position: {ctor: "_Tuple2",_0: 0,_1: dimensions - 1},orientation: LeftBottom}
                         ,{position: {ctor: "_Tuple2",_0: dimensions - 1,_1: 0},orientation: TopRight}
                         ,{position: {ctor: "_Tuple2",_0: dimensions - 1,_1: dimensions - 1},orientation: LeftTop}
                         ,{position: {ctor: "_Tuple2",_0: 0,_1: 0},orientation: BottomRight}]);
   var LeftRight = {ctor: "LeftRight"};
   var TopBottom = {ctor: "TopBottom"};
   var straightWalls = _U.list([{position: {ctor: "_Tuple2",_0: 1,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 2,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 3,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 4,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 5,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 6,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 7,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 8,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 9,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 10,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 11,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 12,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 13,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 14,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 15,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 16,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 17,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 18,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 19,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 20,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 21,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 22,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 23,_1: 0},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 1},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 2},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 3},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 4},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 5},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 6},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 7},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 8},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 9},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 10},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 11},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 12},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 13},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 14},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 15},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 16},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 17},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 18},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 19},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 20},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 21},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 22},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 24,_1: 23},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 23,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 22,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 21,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 20,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 19,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 18,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 17,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 16,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 15,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 14,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 13,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 12,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 11,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 10,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 9,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 8,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 7,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 6,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 5,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 4,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 3,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 2,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 1,_1: 24},orientation: LeftRight}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 23},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 22},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 21},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 20},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 19},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 18},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 17},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 16},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 15},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 14},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 13},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 12},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 11},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 10},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 9},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 8},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 7},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 6},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 5},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 4},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 3},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 2},orientation: TopBottom}
                               ,{position: {ctor: "_Tuple2",_0: 0,_1: 1},orientation: TopBottom}]);
   var outerWalls = A2($List.append,corners,straightWalls);
   var Fence = F3(function (a,b,c) {    return {position: a,orientation: b,age: c};});
   var Wall = F2(function (a,b) {    return {position: a,orientation: b};});
   var Up = {ctor: "Up"};
   var LeftUp = {ctor: "LeftUp"};
   var Left = {ctor: "Left"};
   var LeftDown = {ctor: "LeftDown"};
   var Down = {ctor: "Down"};
   var RightDown = {ctor: "RightDown"};
   var Right = {ctor: "Right"};
   var RightUp = {ctor: "RightUp"};
   var initialRabbits = _U.list([{position: {ctor: "_Tuple2",_0: 10,_1: 10},moveDirection: LeftUp}
                                ,{position: {ctor: "_Tuple2",_0: 11,_1: 10},moveDirection: RightUp}
                                ,{position: {ctor: "_Tuple2",_0: 11,_1: 11},moveDirection: RightDown}
                                ,{position: {ctor: "_Tuple2",_0: 10,_1: 11},moveDirection: LeftDown}]);
   var initialModel = {ai: initialAi
                      ,home: {ctor: "_Tuple2",_0: 1,_1: 1}
                      ...
                      ,turns: 0
                      ,state: Pause};
   var Rabbit = F2(function (a,b) {    return {position: a,moveDirection: b};});
   var AI = F2(function (a,b) {    return {position: a,hasCargo: b};});
   var Model = F9(function (a,b,c,d,e,f,g,h,i) {    return {ai: a,home: b,rabbits: c,walls: d,fences: e,score: f,seed: g,turns: h,state: i};});
   var homeStyle = function () {
      var size = A2($Basics._op["++"],$Basics.toString(cellSize),"px");
      var margin = A2($Basics._op["++"],$Basics.toString(cellSize),"px");
      return $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "background-color",_1: "silver"}
                                            ,{ctor: "_Tuple2",_0: "position",_1: "absolute"}
                                            ,{ctor: "_Tuple2",_0: "margin-left",_1: margin}
                                            ,{ctor: "_Tuple2",_0: "margin-top",_1: margin}
                                            ,{ctor: "_Tuple2",_0: "width",_1: size}
                                            ,{ctor: "_Tuple2",_0: "height",_1: size}]));
   }();
   var instructionsStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                           ,_0: "margin-left"
                                                           ,_1: A2($Basics._op["++"],$Basics.toString(fieldSize + cellSize),"px")}
                                                          ,{ctor: "_Tuple2",_0: "position",_1: "absolute"}
                                                          ,{ctor: "_Tuple2",_0: "top",_1: "0"}]));
   var pageStyle = _U.list([{ctor: "_Tuple2",_0: "background-color",_1: "chartreuse"}
                           ,{ctor: "_Tuple2",_0: "width",_1: A2($Basics._op["++"],$Basics.toString(fieldSize),"px")}
                           ,{ctor: "_Tuple2",_0: "height",_1: A2($Basics._op["++"],$Basics.toString(fieldSize),"px")}]);
   var resultStyle = $Html$Attributes.style(A2($Basics._op["++"],
   pageStyle,
   _U.list([{ctor: "_Tuple2",_0: "opacity",_1: "0.9"}
           ,{ctor: "_Tuple2",_0: "font-size",_1: "52"}
           ,{ctor: "_Tuple2",_0: "text-align",_1: "center"}
           ,{ctor: "_Tuple2",_0: "padding-top",_1: A2($Basics._op["++"],$Basics.toString(fieldSize / 2),"px")}])));
   var pageStyleAttribute = $Html$Attributes.style(pageStyle);
   return _elm.RabbitModel.values = {_op: _op
                                    ,pageStyleAttribute: pageStyleAttribute
                                    ,pageStyle: pageStyle
                                    ...
                                    ,RightBottomLeft: RightBottomLeft
                                    ...
                                    ,fieldSize: fieldSize
                                    ,maxTurns: maxTurns
                                    ,bunnyBounciness: bunnyBounciness
                                    ,fenceLifetime: fenceLifetime
                                    ,fps: fps
                                    ,wallColor: wallColor
                                    ...
                                    ,winningString: winningString
                                    ,initialModel: initialModel
                                    ,outerWalls: outerWalls
                                    ,corners: corners
                                    ,straightWalls: straightWalls
                                    ,initialAi: initialAi
                                    ,initialRabbits: initialRabbits};
};
Elm.RabbitView = Elm.RabbitView || {};
Elm.RabbitView.make = function (_elm) {
   "use strict";
   _elm.RabbitView = _elm.RabbitView || {};
   if (_elm.RabbitView.values) return _elm.RabbitView.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $RabbitModel = Elm.RabbitModel.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var drawCell = F2(function (color,element) {
      var size = A2($Basics._op["++"],$Basics.toString($RabbitModel.cellSize),"px");
      var _p0 = element.position;
      var x = _p0._0;
      var y = _p0._1;
      var leftMargin = $Basics.toString($RabbitModel.cellSize * x);
      var leftMarginString = A2($Basics._op["++"],leftMargin,"px");
      var topMargin = $Basics.toString($RabbitModel.cellSize * y);
      var topMarginString = A2($Basics._op["++"],topMargin,"px");
      var style = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "background-color",_1: color}
                                                 ,{ctor: "_Tuple2",_0: "position",_1: "absolute"}
                                                 ,{ctor: "_Tuple2",_0: "margin-left",_1: leftMarginString}
                                                 ,{ctor: "_Tuple2",_0: "margin-top",_1: topMarginString}
                                                 ,{ctor: "_Tuple2",_0: "width",_1: size}
                                                 ,{ctor: "_Tuple2",_0: "height",_1: size}]));
      return A2($Html.div,_U.list([style]),_U.list([]));
   });
   var drawElement = F2(function (element,color) {    return _U.list([A2(drawCell,color,element)]);});
   var drawElements = F2(function (elements,color) {    var drawColoredCell = drawCell(color);return A2($List.map,drawColoredCell,elements);});
   var drawScore = function (score) {
      var size = A2($Basics._op["++"],$Basics.toString($RabbitModel.cellSize),"px");
      var style = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "z-index",_1: "10"}
                                                 ...
                                                 ,{ctor: "_Tuple2",_0: "text-align",_1: "center"}]));
      return _U.list([A2($Html.div,_U.list([style]),_U.list([$Html.text(score)]))]);
   };
   var drawEnd = function (score) {
      return A2($Html.div,
      _U.list([$RabbitModel.resultStyle]),
      _U.list([$Html.text(A2(F2(function (x,y) {    return A2($Basics._op["++"],x,y);}),$RabbitModel.winningString,$Basics.toString(score)))]));
   };
   var instructions = A2($Html.ul,
   _U.list([]),
   _U.list([A2($Html.li,
           _U.list([]),
           _U.list([$Html.text("The red box is an AI frantically trying to catch fluffy bunnies and bring them home (top left corner).")]))
           ,A2($Html.li,_U.list([]),_U.list([$Html.text("The white boxes are the bunnies chaotically frolicking through the meddow (green).")]))
           ,A2($Html.li,
           _U.list([]),
           _U.list([$Html.text("You can help the AI by clicking on the field and placing fences. These can constrict the bunny movement (for a while).")]))
           ,A2($Html.li,_U.list([]),_U.list([$Html.text("The more bunnies you two catch the more points you get when the game is over.")]))
           ,A2($Html.li,_U.list([]),_U.list([$Html.text("Press Space to pause or unpause the game.")]))]));
   var drawScene = function (model) {
      var subDivs = $List.concat(_U.list([drawScore($Basics.toString(model.score))
                                         ,A2(drawElements,model.walls,$RabbitModel.wallColor)
                                         ,A2(drawElements,model.fences,$RabbitModel.fenceColor)
                                         ,A2(drawElements,model.rabbits,$RabbitModel.rabbitColor)
                                         ,A2(drawElement,model.ai,$RabbitModel.aiColor)
                                         ,_U.list([A2($Html.div,_U.list([$RabbitModel.homeStyle]),_U.list([]))])]));
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,_U.list([$RabbitModel.pageStyleAttribute]),subDivs)
              ,A2($Html.div,_U.list([$RabbitModel.instructionsStyle]),_U.list([instructions]))]));
   };
   var view = function (model) {    return _U.cmp(model.turns,$RabbitModel.maxTurns) > 0 ? drawEnd(model.score) : drawScene(model);};
   return _elm.RabbitView.values = {_op: _op
                                   ,view: view
...
Elm.Rabbit.make = function (_elm) {
   ...
   $RabbitModel = Elm.RabbitModel.make(_elm),
   $RabbitView = Elm.RabbitView.make(_elm),
   $Random = Elm.Random.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var randomDirectionPairGenerator = A2($Random.pair,A2($Random.$int,-1,1),A2($Random.$int,-1,1));
   var randomCoordinateGenerator = A2($Random.pair,A2($Random.$int,1,23),A2($Random.$int,1,23));
   var euclidianDistance = F2(function (_p1,_p0) {
      var _p2 = _p1;
      var _p3 = _p0;
      return $Basics.sqrt($Basics.toFloat(Math.pow(_p3._0 - _p2._0,2) + Math.pow(_p3._1 - _p2._1,2)));
   });
   var pairToDirection = function (pair) {
      var _p4 = pair;
      _v2_8: do {
         switch (_p4._0)
         {case 1: switch (_p4._1)
              {case -1: return $RabbitModel.RightUp;
                 case 0: return $RabbitModel.Right;
                 case 1: return $RabbitModel.RightDown;
                 default: break _v2_8;}
            case 0: switch (_p4._1)
              {case -1: return $RabbitModel.Up;
                 case 1: return $RabbitModel.Down;
                 default: break _v2_8;}
            case -1: switch (_p4._1)
              {case 1: return $RabbitModel.LeftDown;
                 case 0: return $RabbitModel.Left;
                 case -1: return $RabbitModel.LeftUp;
                 default: break _v2_8;}
            default: break _v2_8;}
      } while (false);
      return $RabbitModel.RightDown;
   };
   var ageSingleFence = function (_p5) {    var _p6 = _p5;return A3($RabbitModel.Fence,_p6.position,_p6.orientation,_p6.age - 1);};
   var ageFences = function (fences) {    return A2($List.filter,function (fence) {    return _U.cmp(fence.age,0) > 0;},A2($List.map,ageSingleFence,fences));};
   var addFence = F2(function (fences,_p7) {
      var _p8 = _p7;
      var newFences = _p8._1 ? A2($List._op["::"],
      A3($RabbitModel.Fence,
      {ctor: "_Tuple2",_0: _p8._0._0 / $RabbitModel.cellSize | 0,_1: _p8._0._1 / $RabbitModel.cellSize | 0},
      $RabbitModel.TopBottom,
      $RabbitModel.fenceLifetime),
      fences) : fences;
      return ageFences(newFences);
   });
   var createNewRabbit = function (seed) {
      var _p9 = A2($Random.generate,randomDirectionPairGenerator,seed);
      var directionPair = _p9._0;
      var startingDirection = pairToDirection(directionPair);
      var _p10 = A2($Random.generate,randomCoordinateGenerator,seed);
      var spawnPoint = _p10._0;
      var newSeed = _p10._1;
      return A2($RabbitModel.Rabbit,spawnPoint,startingDirection);
   };
   var createRandomDirection = function (seed) {
      var _p11 = A2($Random.generate,randomDirectionPairGenerator,seed);
      var directionPair = _p11._0;
      return pairToDirection(directionPair);
   };
   var moveNumberCloser = F2(function (a,b) {    return _U.cmp(a,b) > 0 ? a - 1 : a + 1;});
   var moveToward = F2(function (aiPosition,position) {
      var _p12 = position;
      var x = _p12._0;
      var y = _p12._1;
      var _p13 = aiPosition;
      var aiX = _p13._0;
      var aiY = _p13._1;
      var xDistance = $Basics.abs(aiX - x);
      var yDistance = $Basics.abs(aiY - y);
      var newX = _U.eq(aiX,x) ? aiX : A2(moveNumberCloser,aiX,x);
      var newY = _U.eq(aiY,y) ? aiY : A2(moveNumberCloser,aiY,y);
      return _U.cmp(xDistance,yDistance) > 0 ? {ctor: "_Tuple2",_0: A2(moveNumberCloser,aiX,x),_1: aiY} : {ctor: "_Tuple2"
                                                                                                          ,_0: aiX
                                                                                                          ,_1: A2(moveNumberCloser,aiY,y)};
   });
   var pickUpRabbit = F2(function (rabbits,closest) {
      return {ctor: "_Tuple2",_0: A2($List.filter,F2(function (x,y) {    return !_U.eq(x,y);})(closest),rabbits),_1: true};
   });
   var compareAndSave = F3(function (target,rabbit,acc) {
      var distanceToCurrent = A2(euclidianDistance,target,rabbit.position);
      var closest = A2($Maybe.withDefault,{position: {ctor: "_Tuple2",_0: 999,_1: 999},moveDirection: $RabbitModel.Left},$List.head(acc));
      var distanceToSaved = A2(euclidianDistance,target,closest.position);
      return _U.cmp(distanceToCurrent,distanceToSaved) < 0 ? _U.list([rabbit]) : acc;
   });
   var pickClosestRabbit = F2(function (ai,rabbits) {
      var comparer = compareAndSave(ai.position);
      return A2($Maybe.withDefault,
      {position: {ctor: "_Tuple2",_0: 999,_1: 999},moveDirection: $RabbitModel.Left},
      $List.head(A3($List.foldr,comparer,_U.list([]),rabbits)));
   });
   var directionListCreator = function (count) {    return A2($Random.list,count,randomDirectionPairGenerator);};
   var invertDirection = function (direction) {
      var _p14 = direction;
      switch (_p14.ctor)
      {case "Up": return $RabbitModel.Down;
         case "RightUp": return $RabbitModel.LeftDown;
         case "Right": return $RabbitModel.Left;
         case "RightDown": return $RabbitModel.LeftUp;
         case "Down": return $RabbitModel.Up;
         case "LeftDown": return $RabbitModel.RightUp;
         case "Left": return $RabbitModel.Right;
         default: return $RabbitModel.RightDown;}
   };
   var checkForCollision = F4(function (fences,walls,newPosition,rabbit) {
      var isNoCollision = function (element) {    return !_U.eq(element.position,newPosition);};
      return A2($List.all,isNoCollision,fences) && A2($List.all,isNoCollision,walls) ? A2($RabbitModel.Rabbit,
      newPosition,
      rabbit.moveDirection) : A2($RabbitModel.Rabbit,rabbit.position,invertDirection(rabbit.moveDirection));
   });
   var progressRabbit = F3(function (fences,walls,rabbit) {
      var _p15 = rabbit.position;
      var x = _p15._0;
      var y = _p15._1;
      var newPosition = function () {
         var _p16 = rabbit.moveDirection;
         switch (_p16.ctor)
         {case "Up": return {ctor: "_Tuple2",_0: x,_1: y - 1};
            case "RightUp": return {ctor: "_Tuple2",_0: x + 1,_1: y - 1};
            case "Right": return {ctor: "_Tuple2",_0: x + 1,_1: y};
            case "RightDown": return {ctor: "_Tuple2",_0: x + 1,_1: y + 1};
            case "Down": return {ctor: "_Tuple2",_0: x,_1: y + 1};
            case "LeftDown": return {ctor: "_Tuple2",_0: x - 1,_1: y + 1};
            case "Left": return {ctor: "_Tuple2",_0: x - 1,_1: y};
            default: return {ctor: "_Tuple2",_0: x - 1,_1: y - 1};}
      }();
      return A4(checkForCollision,fences,walls,newPosition,rabbit);
   });
   var pickRabbit = function (_p17) {    var _p18 = _p17;return _U.cmp(_p18._0,$RabbitModel.bunnyBounciness) < 0 ? _p18._1 : _p18._2;};
   var randomRabbitMover = F2(function (rabbits,seed) {
      var _p19 = A2($Random.generate,directionListCreator($List.length(rabbits)),seed);
      var newDirections = _p19._0;
      var secondSeed = _p19._1;
      var _p20 = A2($Random.generate,A2($Random.list,$List.length(rabbits),A2($Random.$int,0,10)),secondSeed);
      var changeDirectionList = _p20._0;
      var positions = A2($List.map,function (_) {    return _.position;},rabbits);
      var newRabbits = A3($List.map2,$RabbitModel.Rabbit,positions,A2($List.map,pairToDirection,newDirections));
      return A2($List.map,
      pickRabbit,
      A4($List.map3,F3(function (v0,v1,v2) {    return {ctor: "_Tuple3",_0: v0,_1: v1,_2: v2};}),changeDirectionList,newRabbits,rabbits));
   });
   var moveRabbits = F4(function (fences,walls,rabbits,seed) {
      var rabbitProgression = A2(progressRabbit,fences,walls);
      return A2($List.map,rabbitProgression,A2(randomRabbitMover,rabbits,seed));
   });
   var moveCloserToHome = F2(function (model,actions) {
      var newRabbits = A4(moveRabbits,model.fences,model.walls,model.rabbits,model.seed);
      var _p21 = model.ai.position;
      var x = _p21._0;
      var y = _p21._1;
      var newPosition = _U.cmp(x,y) > 0 ? {ctor: "_Tuple2",_0: x - 1,_1: y} : {ctor: "_Tuple2",_0: x,_1: y - 1};
      var newFences = A2(addFence,model.fences,actions);
      return {ctor: "_Tuple4",_0: {position: newPosition,hasCargo: model.ai.hasCargo},_1: model.score,_2: newRabbits,_3: newFences};
   });
   var findRabbit = F2(function (model,actions) {
      var closestRabbit = A2(pickClosestRabbit,model.ai,model.rabbits);
      var closestRabbitPosition = closestRabbit.position;
      var newAiPosition = A2(moveToward,model.ai.position,closestRabbitPosition);
      var _p22 = _U.eq(model.ai.position,closestRabbitPosition) ? {ctor: "_Tuple2"
                                                                  ,_0: model.ai.position
                                                                  ,_1: A2(pickUpRabbit,model.rabbits,closestRabbit)} : {ctor: "_Tuple2"
                                                                                                                       ,_0: newAiPosition
                                                                                                                       ,_1: {ctor: "_Tuple2"
                                                                                                                            ,_0: A4(moveRabbits,
                                                                                                                            model.fences,
                                                                                                                            ...
                                                                                                                            model.seed)
                                                                                                                            ,_1: false}};
      var updatedPosition = _p22._0;
      var newRabbits = _p22._1._0;
      var cargo = _p22._1._1;
      var newFences = A2(addFence,model.fences,actions);
      return {ctor: "_Tuple4",_0: {position: updatedPosition,hasCargo: cargo},_1: model.score,_2: newRabbits,_3: newFences};
   });
   var dropCargo = F2(function (model,actions) {
      var newScore = model.score + 1;
      var newbornRabbit = createNewRabbit(model.seed);
      var newRabbits = A2(F2(function (x,y) {    return A2($List._op["::"],x,y);}),
      newbornRabbit,
      A4(moveRabbits,model.fences,model.walls,model.rabbits,model.seed));
      var newFences = A2(addFence,model.fences,actions);
      return {ctor: "_Tuple4",_0: {position: model.ai.position,hasCargo: false},_1: newScore,_2: newRabbits,_3: newFences};
   });
   var goHome = F2(function (model,actions) {
      return _U.eq(model.ai.position,model.home) ? A2(dropCargo,model,actions) : A2(moveCloserToHome,model,actions);
   });
   var createNewSeed = function (seed) {    var _p23 = A2($Random.generate,A2($Random.$int,0,42),seed);var newSeed = _p23._1;return newSeed;};
   var move = F2(function (model,actions) {
      var _p24 = model.ai.hasCargo ? A2(goHome,model,actions) : A2(findRabbit,model,actions);
      var newAi = _p24._0;
      var newScore = _p24._1;
      var newRabbits = _p24._2;
      var newFences = _p24._3;
      var _p25 = actions;
      var space = _p25._2;
      return {ai: newAi
             ,home: model.home
             ...
             ,turns: model.turns + 1
             ,state: $RabbitModel.Running};
   });
   var checkWinSituation = F2(function (model,actions) {
      var newState = _U.cmp(model.turns,$RabbitModel.maxTurns) > 0 ? $RabbitModel.End : $RabbitModel.Running;
      var _p26 = newState;
      switch (_p26.ctor)
      {case "Running": return A2(move,model,actions);
         case "End": return A9($RabbitModel.Model,
           model.ai,
           model.home,
           model.rabbits,
           model.walls,
   ...
   var pauseGame = function (model) {
      return A9($RabbitModel.Model,model.ai,model.home,model.rabbits,model.walls,model.fences,model.score,model.seed,model.turns,$RabbitModel.Pause);
   };
   var update = F2(function (actions,model) {
      var _p27 = actions;
      var space = _p27._2;
      var _p28 = model.state;
      switch (_p28.ctor)
      {case "Pause": return space ? A2(checkWinSituation,model,actions) : model;
         case "End": return space ? A2(checkWinSituation,$RabbitModel.initialModel,actions) : model;
         default: return space ? pauseGame(model) : A2(checkWinSituation,model,actions);}
   });
   var game = A3($Signal.foldp,
   update,
   $RabbitModel.initialModel,
   A2($Signal.sampleOn,
   $Time.fps($RabbitModel.fps),
   A4($Signal.map3,F3(function (v0,v1,v2) {    return {ctor: "_Tuple3",_0: v0,_1: v1,_2: v2};}),$Mouse.position,$Mouse.isDown,$Keyboard.space)));
   var main = A2($Signal.map,$RabbitView.view,game);
   return _elm.Rabbit.values = {_op: _op
                               ,main: main
                               ,game: game
                               ,update: update
                               ,pauseGame: pauseGame
                               ,checkWinSituation: checkWinSituation
                               ,move: move
                               ,createNewSeed: createNewSeed
                               ,goHome: goHome
                               ,dropCargo: dropCargo
                               ,moveRabbits: moveRabbits
                               ,randomRabbitMover: randomRabbitMover
                               ,pickRabbit: pickRabbit
                               ,progressRabbit: progressRabbit
                               ,checkForCollision: checkForCollision
                               ,invertDirection: invertDirection
                               ,directionListCreator: directionListCreator
                               ,moveCloserToHome: moveCloserToHome
                               ,findRabbit: findRabbit
                               ,pickClosestRabbit: pickClosestRabbit
                               ,compareAndSave: compareAndSave
                               ,pickUpRabbit: pickUpRabbit
                               ,moveToward: moveToward
                               ,moveNumberCloser: moveNumberCloser
                               ,createRandomDirection: createRandomDirection
                               ,createNewRabbit: createNewRabbit
                               ,addFence: addFence
                               ,ageFences: ageFences
                               ,ageSingleFence: ageSingleFence
                               ,pairToDirection: pairToDirection
                               ,euclidianDistance: euclidianDistance
                               ,randomCoordinateGenerator: randomCoordinateGenerator
                               ,randomDirectionPairGenerator: randomDirectionPairGenerator};
};
